...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DCBook.part_tb_id'
        db.delete_column('duchemin_dcbook', 'part_tb_id')

        # Adding field 'DCBook.part_sb_id'
        db.add_column('duchemin_dcbook', 'part_sb_id',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DCBook.part_tb_id'
        db.add_column('duchemin_dcbook', 'part_tb_id',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DCBook.part_sb_id'
        db.delete_column('duchemin_dcbook', 'part_sb_id')
