...
class AnalysisForm(forms.Form):
    ...
    voice_role_dux2 = forms.ChoiceField(required=False, choices=FOUR_VOICES, widget=forms.RadioSelect, label="Dux 2 (ID or PEn)")
    voice_role_com2 = forms.ChoiceField(required=False, choices=FOUR_VOICES, widget=forms.RadioSelect, label="Comes 2 (ID or PEn)")
