...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DCContentBlock.position'
        db.add_column('duchemin_dccontentblock', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DCContentBlock.position'
        db.delete_column('duchemin_dccontentblock', 'position')
