...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DCPerson', fields ['surname']
        db.create_index('duchemin_dcperson', ['surname'])

        # Adding index on 'DCPerson', fields ['person_id']
        db.create_index('duchemin_dcperson', ['person_id'])

        # Adding index on 'DCPiece', fields ['piece_id']
        db.create_index('duchemin_dcpiece', ['piece_id'])

        # Adding index on 'DCPhrase', fields ['phrase_id']
        db.create_index('duchemin_dcphrase', ['phrase_id'])

        # Adding index on 'DCBook', fields ['book_id']
        db.create_index('duchemin_dcbook', ['book_id'])

        # Adding index on 'DCBook', fields ['title']
        db.create_index('duchemin_dcbook', ['title'])


    def backwards(self, orm):
        # Removing index on 'DCBook', fields ['title']
        db.delete_index('duchemin_dcbook', ['title'])

        # Removing index on 'DCBook', fields ['book_id']
        db.delete_index('duchemin_dcbook', ['book_id'])

        # Removing index on 'DCPhrase', fields ['phrase_id']
        db.delete_index('duchemin_dcphrase', ['phrase_id'])

        # Removing index on 'DCPiece', fields ['piece_id']
        db.delete_index('duchemin_dcpiece', ['piece_id'])

        # Removing index on 'DCPerson', fields ['person_id']
        db.delete_index('duchemin_dcperson', ['person_id'])

        # Removing index on 'DCPerson', fields ['surname']
        db.delete_index('duchemin_dcperson', ['surname'])
